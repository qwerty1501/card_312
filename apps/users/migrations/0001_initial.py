    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.PositiveSmallIntegerField(choices=[(1, 'Обычный пользователь'), (2, 'Партнер')], default=1, verbose_name='Тип пользователя')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('user_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='users.user')),
                ('image', models.FileField(blank=True, null=True, upload_to=apps.users.services.get_upload_path, validators=[apps.users.services.validate_file_extension], verbose_name='Загрузить фон *(305x210)')),
                ('address', models.CharField(max_length=64, verbose_name='Адрес компании')),
                ('org', models.CharField(blank=True, max_length=64, null=True, verbose_name='Организационная правовая форма')),
                ...
                ('phone_one', models.CharField(max_length=32, verbose_name='Номера телефонов')),
